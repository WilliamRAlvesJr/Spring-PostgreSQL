...
<html>
	<head>
		...
		<title>Sistema Hospital - Adicionar/Editar Setor</title>
		<link href="base.css" type="text/css" rel="stylesheet">
	</head>

	<body>
		<div align="center">
        	<h1>Adicionar/Editar Setor</h1>
        	<br />
        	...
        	<br />
	        <form id="setores" action="/setores/salvar" method = "POST" modelAttribute="setores">
	        ...
	        <form id="setores" action="/setores" method = "GET">
				<button type="submit">Setores</button>
			</form>
		</div>
	</body>
</html>